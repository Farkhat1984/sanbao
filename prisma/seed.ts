  ...
  const specializedAgents: SpecializedAgentDef[] = [
    ...
    },
    {
      ...
      mcp: {
        id: "mcp-docker",
        name: "Docker",
        url: process.env.DOCKER_MCP_URL || "http://localhost:3106/mcp",
        transport: "STREAMABLE_HTTP",
        apiKey: null,
      },
    },
    {
      ...
      mcp: {
        id: "mcp-notion",
        name: "Notion",
        url: process.env.NOTION_MCP_URL || "http://localhost:3107/mcp",
        transport: "STREAMABLE_HTTP",
    ...
    },
    {
      ...
      mcp: {
        id: "mcp-n8n",
        name: "n8n",
        url: process.env.N8N_MCP_URL || "http://localhost:3108/mcp",
        transport: "STREAMABLE_HTTP",
    ...
    },
    {
      ...
      mcp: {
        id: "mcp-exa",
        name: "Exa",
        url: process.env.EXA_MCP_URL || "http://localhost:3109/mcp",
        transport: "STREAMABLE_HTTP",
    ...
    },
    {
      ...
      mcp: {
        id: "mcp-supabase",
        name: "Supabase",
        url: process.env.SUPABASE_MCP_URL || "http://localhost:3110/mcp",
        transport: "STREAMABLE_HTTP",
